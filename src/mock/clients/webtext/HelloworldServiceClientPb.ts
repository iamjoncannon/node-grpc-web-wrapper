...
export class GreeterClient {
  ...
  methodDescriptorUnimplementedSayHello = new grpcWeb.MethodDescriptor(
    '/helloworld.Greeter/UnimplementedSayHello',
    grpcWeb.MethodType.UNARY,
    helloworld_pb.HelloRequest,
    helloworld_pb.HelloReply,
    (request: helloworld_pb.HelloRequest) => {
  ...
  unimplementedSayHello(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        ...
        request,
        metadata || {},
        this.methodDescriptorUnimplementedSayHello,
        callback);
    }
    return this.client_.unaryCall(
    this.hostname_ +
  ...
  methodDescriptorSayRepeatHello = new grpcWeb.MethodDescriptor(
    ...
    helloworld_pb.RepeatHelloRequest,
    helloworld_pb.HelloReply,
  ...
  sayRepeatHello(
    request: helloworld_pb.RepeatHelloRequest,
    metadata?: grpcWeb.Metadata): grpcWeb.ClientReadableStream<helloworld_pb.HelloReply> {
